...
@section('content')
                        ...
                        <div >
                            <div class="card-body p-0">
                                <table class="table">
                                    ...
                                    <tr>
                                        <td>5.</td>
                                        <td>Date d’enlèvement de la marchandise</td>
                                        <td><span>{{$formulaire->champs['date_enlever']}}</span></td>
                                    </tr>
                                    <tr>
                                        <td>6.</td>
                                        <td>Marchandise à enlever</td>
                                        <td><span>{{$formulaire->champs['marchandise']}}</span></td>
                                    </tr>
                                    <tr>
                                        <td>7.</td>
                                        <td>Mode de conditionnement de la marchandise</td>
                                    ...
                                    <tr>
                                        ...
                                        <td><span>{{$formulaire->champs['date_declaration']}}</span></td>
                                    </tr>
                                    <tr>
                                        <td>11.</td>
                                        <td>Numéro de déclaration</td>
                                        <td><span>{{$formulaire->champs['num_declaration']}}</span></td>
                                    </tr>
                                    </tbody>
                                </table>
                            </div>
    ...
    {{ Form::model($formulaire, array('route' => array('bon_a_enlevers.validatation', $formulaire->id), 'method' => 'PUT')) }}
